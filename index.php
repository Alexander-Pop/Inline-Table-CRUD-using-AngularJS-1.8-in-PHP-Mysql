<html>  
    <head>  
        <title>Inline Table CRUD using AngularJS 1.8.0 in PHP Mysql</title>  
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" />  
        <script src="http://ajax.googleapis.com/ajax/libs/angularjs/1.8.0/angular.min.js"></script>  
    </head>  
    <body>  
        <div class="container">  
            <h3 align="center">Inline Table CRUD using AngularJS 1.8 in PHP Mysql</h3><br />
                ...
                $scope.deleteData = function(id){
                    if(confirm("Are you sure you want to remove it?")) {
                        $http({
                            ...
                            $scope.success = true;
                            $scope.successMessage = call.data.message;
                            $scope.fetchData();
                        }); 
                    }
                };
